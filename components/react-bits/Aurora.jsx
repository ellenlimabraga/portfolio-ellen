"use client";
// Adapted from React Bits — Aurora (JS/CSS). Owned source in-project.
...
export default function Aurora({
  colorStops = ["#ff9838", "#ff2d78", "#a855f7"],
  amplitude = 1.0,
  blend = 0.5,
  speed = 1.0,
  className = "",
  ...
  useEffect(() => {
    ...
    const toRGB = (arr) => arr.map((hex) => { const c = new Color(hex); return [c.r, c.g, c.b]; });
    ...
    const update = (t) => {
      ...
      program.uniforms.uTime.value = (t * 0.001 * (p.speed ?? 1)) * 0.5;
